...
export function ImageZoom({ className, backdropClassName, ...props }) {
  return (
    <div
      className={cn(
        'relative',
    ...
    >
      <Zoom
        classDialog={cn(
          ...
          '[&_[data-rmiz-modal-overlay="visible"]]:!bg-black/40 [&_[data-rmiz-modal-overlay="visible"]]:!backdrop-blur-md',
