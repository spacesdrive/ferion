import { Brain, Clapperboard, Cpu, Gamepad2, Languages, Trophy, Video } from 'lucide-react';
...
const tileByTitle = {
  ...
  'Content Creation': { Icon: Video, gradient: 'from-emerald-500 to-teal-400' },
